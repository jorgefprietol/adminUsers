          ...
          <div class="tab-content" id="v-pills-tabContent">
            ...
            <div id="datos" class="tab-pane fade show active" role="tabpanel" aria-labelledby="v-pills-home-tab">
              ...
              <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="form-group row">
          				<label class="col-sm-3 col-form-label text-sm-right">Apellido</label>
          				<div class="col-sm-9">
          					<input type="text" class="form-control @error('apellido') is-invalid @enderror" name="apellido" maxlength="254" value="{{ old('apellido', Auth::user()->apellido) }}" required>
                    @error('apellido') <div class="invalid-feedback">{{ $message }}</div> @enderror
          				</div><!-- /.col -->
          			</div><!-- /.form-group row -->
                <div class="form-group row">
          				<label class="col-sm-3 col-form-label text-sm-right">Dirección</label>
          				<div class="col-sm-9">
          					<input type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" maxlength="254" value="{{ old('direccion', Auth::user()->direccion) }}" required>
                    @error('direccion') <div class="invalid-feedback">{{ $message }}</div> @enderror
          				</div><!-- /.col -->
          			</div><!-- /.form-group row -->
                <div class="form-group row">
          				<label class="col-sm-3 col-form-label text-sm-right">Fecha Nac.</label>
          				<div class="col-sm-9">
          					<input type="date" class="form-control @error('nacimiento') is-invalid @enderror" name="nacimiento" maxlength="254" value="{{ old('nacimiento', Auth::user()->nacimiento) }}" required>
